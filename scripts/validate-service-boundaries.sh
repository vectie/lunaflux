...
# Exact public closure for the transport-neutral online framed coordinator.
# The coordinator owns all mutable lower capabilities and returns only opaque
# ingress, output-offer, rejection, progress, preparation, and cleanup values.
