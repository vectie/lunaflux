...
whole-string UTF-16 validation and UTF-8 materialization before byte work. A
future request-admission slice must add an incrementally budgeted text stage and
a fixed-capacity cooperative tokenizer pool before network ingress; this
