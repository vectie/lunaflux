...
#include <math.h>
#include <stdint.h>
extern "C" __global__ void lunaflux_luna_dense_projection_bf16_reference_v1_op_4_ep_5(const int32_t *counts, const __nv_bfloat16 *input, const __nv_bfloat16 *weight, __nv_bfloat16 *output) {
  ...
  const unsigned long long column = index % 4ULL;
