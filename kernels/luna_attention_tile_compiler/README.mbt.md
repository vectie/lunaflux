...
`compile_attention_tile_frontier` retains every legal generated combination.
Uncalibrated work/storage estimates rank fallback choices but cannot remove
alternatives before measurement. This is the functional boundary for
